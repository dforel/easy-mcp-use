...
<img className="block dark:hidden" src="/images/hero-light1.png" alt="easy-mcp-use Light Theme" />
<img className="hidden dark:block" src="/images/hero-dark1.png" alt="easy-mcp-use Dark Theme" />
